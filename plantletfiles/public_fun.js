...
// 媒体播放媒体播放
wsf.Mp3PlayFun = function(audioModule){
    var mp3Wrap = $('.ev-audio-module');
    if(mp3Wrap.length){
...
wsf.fullRow = {
    ...
    addBtnliItem: function(){
        var btnliItemArr = [];
        $("#headFullXY, #main_container .customModuleRow, .customModuleRowGroup, #footer").each(function(i, dom){
            dom = $(dom);
